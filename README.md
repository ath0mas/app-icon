...
To create template [Notification Icon for Android](https://developer.android.com/guide/topics/ui/notifiers/notifications) include the `--notification-icons` flag.
